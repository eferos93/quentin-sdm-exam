...
public class Graphics {
    ...
    public static void BlackPlayerPlayFirst() {
        System.out.println(Message.BLACKPLAYFIRST);
    }

    public static void ChooseCoordinateX() {
        System.out.println(Message.CHOOSE_X);
    }

    public static void ChooseCoordinateY() {
